-- ========================================
-- 知識ベース拡張（修正版）
-- Fixed Knowledge Base Expansion
-- 既存のstarsテーブルに対応
-- ========================================

-- ========================================
-- PART 1: 既存starsテーブルに列を追加
-- ========================================

-- 既存のstarsテーブルに不足している列を追加
...
-- idのデータ型をINTEGERに統一（既にINTの場合は何もしない）
-- CHECK制約を追加
DO $$
BEGIN
    IF NOT EXISTS (
...
('水', '木', 'sojo', 'seiki',
 ...
 '雨水が樹木を成長させる。', '進展・発展のエネルギーを得る。'),
('木', '火', 'sojo', 'seiki',
 '木が燃えて火を生む関係。', '薪が燃えて炎を作る。', '名声・名誉を得る。'),
('火', '土', 'sojo', 'seiki',
 '火が燃え尽きて灰（土）となる関係。', '火山灰が肥沃な大地を作る。', '財産・不動産を得る。'),
('土', '金', 'sojo', 'seiki',
 '土の中で金属が生まれる関係。', '鉱山から金属が採掘される。', '金運上昇。'),
('金', '水', 'sojo', 'seiki',
 '金属の表面に水滴が結ぶ関係。', '金属に朝露が結ぶ。', '智慧を得る。')
